...
public abstract class MyIntro extends AppCompatActivity {
...
//        permissionNotGrantedClickListener = new PermissionNotGrantedClickListener(getBaseContext(, nextButtonTranslationWrapper);
